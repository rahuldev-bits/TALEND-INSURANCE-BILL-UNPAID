...
/**
 * Job: TALEND_DEMO Purpose: <br>
 * Description:  <br>
 * @author mranal.jain16@gmail.com
 * @version 8.0.1.20231017_1026-patch
 * @status 
 */
public class TALEND_DEMO implements TalendJob {
	static {System.setProperty("TalendJob.log", "TALEND_DEMO.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(TALEND_DEMO.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "TALEND_DEMO";
	private final String projectName = "BITS";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "__--9YOwpEe6Y4e0iMovfvw", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TALEND_DEMO.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tPrejob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "btv6L3_" + subJobPidCounter.getAndIncrement());
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "qJ9lJa_" + subJobPidCounter.getAndIncrement());
	...
	currentComponent="tDBConnection_1";
		...
		int tos_count_tDBConnection_1 = 0;
                ...
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("HOST" + " = " + "\"bits-insurance.database.windows.net\"");
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PORT" + " = " + "\"1433\"");
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("SCHEMA_DB" + " = " + "\"dbo\"");
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("DBNAME" + " = " + "\"INSURANCE-CORE\"");
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("USER" + " = " + "\"rojha4\"");
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:eqk97nBTeu6CArKy1U6VhOjgEShIdTAHBu6LrFOqR+I28kAifwkj6A3Ydt4=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBConnection_1", "tDBConnection_1", "tMSSqlConnection");
				talendJobLogProcess(globalMap);
			}
		    ...
		    String url_tDBConnection_1 = "jdbc:sqlserver://" + "bits-insurance.database.windows.net" ;
		String port_tDBConnection_1 = "1433";
		String dbname_tDBConnection_1 = "INSURANCE-CORE" ;
    	if (!"".equals(port_tDBConnection_1)) {
    		url_tDBConnection_1 += ":" + "1433";
    	}
    	if (!"".equals(dbname_tDBConnection_1)) {
    				    
		    	url_tDBConnection_1 += ";databaseName=" + "INSURANCE-CORE"; 
    	}

		url_tDBConnection_1 += ";appName=" + projectName + ";" + "";  
	String dbUser_tDBConnection_1 = "rojha4";
	
	
		 
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:K0p58MolEexEdtNU3QA4qzA1PNXjFsjGo6j1PWpeiD6iTO6iqHmccQtP+lo=");
	...
	globalMap.put("db_tDBConnection_1",  "INSURANCE-CORE");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_BITS_TALEND_DEMO = new byte[0];
    static byte[] commonByteArray_BITS_TALEND_DEMO = new byte[0];
				...
				public Boolean subscriber_idIsNullable(){
				    return true;
				}
				public Boolean subscriber_idIsKey(){
				    return false;
				}
				public Integer subscriber_idLength(){
				    return null;
				}
				public Integer subscriber_idPrecision(){
				    return null;
				}
				public String subscriber_idDefault(){
				
					return null;
				
				}
				public String subscriber_idComment(){
				
				    return "";
				
				}
				public String subscriber_idPattern(){
				
					return "";
				
				}
				public String subscriber_idOriginalDbColumnName(){
				...
				public Boolean contact_numberIsNullable(){
				    return true;
				}
				public Boolean contact_numberIsKey(){
				    return false;
				}
				public Integer contact_numberLength(){
				    return null;
				}
				public Integer contact_numberPrecision(){
				    return null;
				}
				public String contact_numberDefault(){
				
					return null;
				
				}
				public String contact_numberComment(){
				
				    return "";
				
				}
				public String contact_numberPattern(){
				
					return "";
				
				}
				public String contact_numberOriginalDbColumnName(){
				...
				public Boolean due_dateIsNullable(){
				    return true;
				}
				public Boolean due_dateIsKey(){
				    return false;
				}
				public Integer due_dateLength(){
				    return null;
				}
				public Integer due_datePrecision(){
				    return null;
				}
				...
				public String due_dateComment(){
				
				    return "";
				
				}
				public String due_datePattern(){
				
					return "dd-MM-yyyy";
				
				}
				public String due_dateOriginalDbColumnName(){
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BITS_TALEND_DEMO.length) {
				if(length < 1024 && commonByteArray_BITS_TALEND_DEMO.length == 0) {
   					commonByteArray_BITS_TALEND_DEMO = new byte[1024];
				} else {
   					commonByteArray_BITS_TALEND_DEMO = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BITS_TALEND_DEMO, 0, length);
			strReturn = new String(commonByteArray_BITS_TALEND_DEMO, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_BITS_TALEND_DEMO, 0, length);
			strReturn = new String(commonByteArray_BITS_TALEND_DEMO, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BITS_TALEND_DEMO) {

        	try {

        		int length = 0;
		
					this.subscriber_id = readString(dis);
					
					this.first_name = readString(dis);
					
					this.last_name = readString(dis);
					
					this.contact_number = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.subscriber_id,dos);
					...
					// String
						...
						writeString(this.contact_number,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("subscriber_id="+subscriber_id);
...
public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "bDupD0_" + subJobPidCounter.getAndIncrement());
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "\"C:/Users/rojha4/workspace/unbilled_subscribers.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/rojha4/workspace/unbilled_subscribers.csv")).getAbsolutePath().replace("\\","/");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"  select S.subscriber_id, first_name, last_name,  contact_number, invoice_date, due_date, amount  from Subscriber S  inner join Billing B  on B.subscriber_id = S.subscriber_id  and not exists (      select * from Payment P      where P.bill_id = B.bill_id  )  \"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("subscriber_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("first_name")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("last_name")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("contact_number")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("invoice_date")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("due_date")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("amount")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
...
+"l_id = B.bill_id\n)\n";
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.subscriber_id = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.subscriber_id = tmpContent_tDBInput_1;
                }
            } else {
                row1.subscriber_id = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.contact_number = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.contact_number = tmpContent_tDBInput_1;
                }
            } else {
                row1.contact_number = null;
            }
			...
			row1.invoice_date = mssqlGTU_tDBInput_1.getDate(rsmd_tDBInput_1, rs_tDBInput_1, 5);
			...
			row1.due_date = mssqlGTU_tDBInput_1.getDate(rsmd_tDBInput_1, rs_tDBInput_1, 6);
            ...
            row1.amount = rs_tDBInput_1.getDouble(7);
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tDBInput_1","tDBInput_1","tMSSqlInput","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row1.due_date, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.amount != null) {
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				log.debug("tFileOutputDelimited_1 - Written records count: " + nb_line_tFileOutputDelimited_1 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tDBInput_1","tDBInput_1","tMSSqlInput","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "pnjeCH_" + subJobPidCounter.getAndIncrement());
 ...
 */
    ...
    public static void main(String[] args){
        final TALEND_DEMO TALEND_DEMOClass = new TALEND_DEMO();

        int exitCode = TALEND_DEMOClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'TALEND_DEMO' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'TALEND_DEMO' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","__--9YOwpEe6Y4e0iMovfvw");
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-03-27T11:40:01.323820100Z");
        ...
        try {
            ...
            java.io.InputStream inContext = TALEND_DEMO.class.getClassLoader().getResourceAsStream("bits/talend_demo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TALEND_DEMO.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'TALEND_DEMO' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TALEND_DEMO");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'TALEND_DEMO' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     97425 characters generated by Talend Cloud Data Management Platform 
 *     on the March 27, 2024 at 11:40:01 AM GMT
 ************************************************************************************************/